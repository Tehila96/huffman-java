...
public class Leaf extends Node {
    ...
    public Map<Character, List<Boolean>> traverse(List<Boolean> list) {
        Map<Character, List<Boolean>> leafMap = new HashMap<>(); //creating a new map
        leafMap.put(label,list); //storing label and leaf in the map

        return leafMap;//returning the map
    }
}
